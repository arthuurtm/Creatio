	...
	const definitions = createDefinitions({
		...
		hasStatus: {
			...
			params: [
				...
				{ key: "active", label: "Ativo?", type: "switch", default: true },
				{
					key: "playerId",
					label: "Jogador",
					type: "select",
		...
		isQuestActive: {
			...
			params: [
				...
				},
				{
					...
					label: "Status",
					type: "select",
					items: ["not_started", "active", "completed", "failed"],
					default: "active",
				},
			],
			execute: (params) =>
