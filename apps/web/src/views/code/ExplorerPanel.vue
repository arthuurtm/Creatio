...
// activeNodes é um prop simples — sem defineModel, sem v-model.
// O painel só exibe os nós; edições individuais vão direto à store
// pelo ComponentQuickEditPanel que recebe os objetos por referência.
const props = defineProps<{
  ...
  allExpanded: boolean;
  editorStore: any;
  // array já filtrado por categoria — vem de editorStore[activeCategory]
  activeNodes: SDKNode[];
}>();
