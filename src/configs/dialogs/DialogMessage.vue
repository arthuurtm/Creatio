<template>
  <div class="modal" @click.stop>
    ...
    <div class="modal-buttons">
      <button :class="params.btn1?.class" @click="handleBtn1">
        {{ params.btn1?.text }}
      </button>
      <button v-if="params.btn2?.text" :class="params.btn2?.class" @click="handleBtn2">
        {{ params.btn2?.text }}
      </button>
    </div>
  </div>
